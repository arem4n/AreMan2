...
const TommyBoxCaseStudy: React.FC = () => (
    <section>
        ...
        <Block>
            ...
            <ImageDisplay src="https://i.postimg.cc/9fRkMsbx/Diseno-sin-titulo-20251124-154417-0000.png" alt="Logo Versión 1 TommyBox" caption="Versión 1 (Histórica): Paleta verde/negro, más tradicional." />
            ...
            <ImageDisplay src="https://i.postimg.cc/rpM8kSt5/20251103_141407_0000.png" alt="Logo TommyBox Final" caption="Isotipo y Logotipo principal final (V2)." />
        </Block>
        ...
        <Block>
            ...
            <ImageDisplay src="https://i.postimg.cc/gcgBVvJf/1764011987123.jpg" alt="Gimnasio TommyBox" caption="El espacio físico real donde se desarrolló el método. La identidad visual habita el gimnasio." />
            <ImageDisplay src="https://i.postimg.cc/9M2Cx5Y0/1764115781652.jpg" alt="Merchandising TommyBox" caption="Aplicación de la marca en indumentaria oficial (Poleras)." />
            <ImageDisplay src="https://i.postimg.cc/CLbZLZj7/20251126-163614-0000.png" alt="Variaciones de Color TommyBox" caption="Versatilidad del diseño: Adaptación a diferentes colores de indumentaria." />
            <ImageDisplay src="https://i.postimg.cc/7hmh2RNF/1764191495962.jpg" alt="Botella de Agua TommyBox" caption="Extensión de marca: Merchandising funcional para la comunidad." />
        </Block>
    </section>
);
