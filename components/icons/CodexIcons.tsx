...
// 1. Semiótica: Un Ojo con un destello (Visión/Percepción)
...
// 2. Capas: Bloques Isométricos (Profundidad/Estructura)
export const LayersIcon: React.FC = () => (
    <IconWrapper>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L12 7.5l4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0l-4.179 2.25L12 21.75 6.429 18.75m0 0l5.571-3m5.571 3L21.75 15.75" />
    </IconWrapper>
);

// 3. Arquetipos: Una Corona (Personalidad/Rey/Poder)
...
// 4. Narrativa: Pluma de escribir (Historia/Origen)
...
// 5. Sistema Transmedia: Red de Nodos (Conexión/Expansión)
