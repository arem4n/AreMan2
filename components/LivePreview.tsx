...
export const LivePreview: React.FC<LivePreviewProps> = ({ src, title }) => {
    return (
        <section className="w-full max-w-[1200px] aspect-[16/9] overflow-hidden rounded-2xl shadow-[0_18px_60px_rgba(0,0,0,0.35)] mx-auto my-16 bg-deep-50 relative group">
